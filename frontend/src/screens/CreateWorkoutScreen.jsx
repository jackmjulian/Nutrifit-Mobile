...
const CreateWorkoutScreen = () => {
  ...
  const { data: exerciseData, refetch: refetchExerciseData } =
    useGetExercisesQuery();

  // console.log('workout name', workout?.workout_name);
  // console.log('workout exercises', workout?.workout_exercises);

  // TODO: Change all 'sets' to 'exercise_sets'
  // Define initialExercise object with fetched data if available
        ...
        try {
          ...
          for (const exercise of exercises) {
            ...
            const addedExercise = await addExerciseToWorkout(
              ...
              // console.log('added Exercise', exercise.exercise_id)
            );
